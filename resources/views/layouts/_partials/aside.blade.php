	...
	<ul class="menu-inner py-1">
		...
		<li class="menu-item {{ menuIsActive('projects.*') }}">
			<a href="{{ route('projects.index') }}" class="menu-link">
				...
				<div data-i18n="Project management">
					{{ __('Project management') }}
				</div>
			</a>
		</li>

		<li class="menu-item {{ menuIsActive('tasks.*') }}">
			<a href="{{ route('tasks.index') }}" class="menu-link">
				<i class="menu-icon tf-icons bx bx-task"></i>
				<div data-i18n="Task management">
					{{ __('Task management') }}
				</div>
			</a>
		</li>
		{{-- <li class="menu-item {{ menuIsActive('status.*') }}">
			<a href="{{ route('status.index') }}" class="menu-link">
				<i class="menu-icon tf-icons bx bx-copy-alt"></i>
				<div data-i18n="Status management">
					{{ __('Status management') }}
				</div>
			</a>
		</li> --}}

		<li class="menu-item {{ menuIsActive('category.*') }}">
			<a href="{{ route('category.index') }}" class="menu-link">
				<i class="menu-icon tf-icons bx bx-category"></i>
				<div data-i18n="Category management">
